...
<%@page import="com.beans.Category"%><%@page import="com.beans.Blog"%>
...
<html lang="en">
  ...
  <body> 
    ...
    <jsp:useBean id="blog" class="com.beans.Blog" scope="session"></jsp:useBean>
        ...
        System.out.println("Blod id: " + blog.getId());  
       ...
       %>
        ...
        <center>
                        ...
                        <br/><br/>
                        <input type="submit" value="Proceed to save" name="submit" class="btn btn-primary"/>
                        </form>
                    </center>
                </div>
