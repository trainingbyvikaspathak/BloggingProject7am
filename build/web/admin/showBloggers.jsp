      ...
      <jsp:include page="header.jsp"></jsp:include>
        <div class="templatemo-content-container">
            ...
            <tr>
                    ...
                    <td><img src="../<%=blogger.getPic()%>" style="width:70px;height: 70px;border-radius: 50%"/></td>
                    <th class="<%=blogger.getStatus().equals("pending")?"text-danger font-weight-bold":""%>">
                        <%=blogger.getStatus()%></th>
